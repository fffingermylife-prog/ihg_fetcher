...
def _build_holidays():
    ...
    # 单天假期 (元旦/清明/端午/中秋), 仅当天不加缓冲, 减少噪音
    # 农历节日公历日期: 每年通过农历推算; 注意 2026 端午=6/19 (周五), 2027 端午=6/9 (周三)
    short_holidays = {
        "2026-01-01": "元旦",
        "2026-04-05": "清明",
        "2026-06-19": "端午",   # 农历乙巳年五月初五
        "2026-09-25": "中秋",   # 农历乙巳年八月十五
        "2027-01-01": "元旦",
        "2027-04-05": "清明",
        "2027-06-09": "端午",   # 农历丙午年五月初五
        "2027-09-15": "中秋",   # 农历丙午年八月十五
    }
